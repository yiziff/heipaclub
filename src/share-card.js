...
export async function buildShareCardBlob(state) {
  ...
  ctx.fillStyle = INK;
  ctx.fillText(fitText(ctx, artistName || "黑怕", W - M * 2), W / 2, 108);
  if (champion?.title) {
  ...
  /* Champion cover */
  ctx.save();
  ctx.shadowColor = "rgba(184,255,26,0.35)";
  ctx.shadowBlur = 36;
  ...
  brandGrad.addColorStop(0, "#5a7a12");
  brandGrad.addColorStop(0.55, "#7a9a1e");
